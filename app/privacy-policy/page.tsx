...
import NavBar from '@/components/NavBar'; // Assuming NavBar is used globally
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <section className="mb-6">
          ...
          <p>
            Welcome to WealthBuilder Mortgage ("we", "us", "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us.
          </p>
          <p className="mt-2">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">2. What Information Do We Collect?</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">3. How Do We Use Your Information?</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">4. Will Your Information Be Shared With Anyone?</h2>
          <p>
          ...
          <ul className="list-disc list-inside ml-4 mt-2">
            ...
            {/* Add others like hosting providers, analytics, etc. */}
          </ul>
          <p className="mt-2">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">5. Stripe's Role</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">7. How Long Do We Keep Your Information?</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">9. Use of Cookies</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">10. Updates To This Notice</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">11. How Can You Contact Us About This Notice?</h2>
          <p>
            If you have questions or comments about this notice, you may email us at [Your Contact Email] or by post to:
          </p>
          <p className="mt-2">[Your Company Name]</p>
